...
describe("Unit Test: Date of birth to Age convertor", function () {
    ...
    beforeEach(function () {
        ...
        module("madeasy.common.convertors");

        inject(["madeasy.common.dateOfBirthToAge", function (_ageConvertor) {
    ...
    it("Should show age as being 'Less than a day old' when day diffrence is 0",
    function () {
        // Zero years, zero months 0 days
        var startDate = "2015-12-10";
        var endDate = "2015-12-10";
        var age = ageConvertor.getAge(startDate, endDate);
        expect(age).toEqual("Less than a day old");
    });
});
